    ...
    <footer className="bg-slate-900 text-slate-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 mb-6 max-w-sm">
              Your personal AI mentor for a deeper Christian life. 
              Tailored to your tradition, available 24/7.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <h4 className="text-white font-semibold mb-4">Supported Denominations</h4>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <span className="text-xs text-slate-600">
                Available in: English, Afrikaans, isiZulu, isiXhosa
              </span>
            </div>
          </div>
        </div>
